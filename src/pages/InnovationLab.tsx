            ...
            <div className="max-w-6xl mx-auto">
              {isLoading ? (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {[...Array(6)].map((_, i) => (
                    <div key={i} className="bg-agenko-dark-lighter rounded-lg overflow-hidden animate-pulse">
                      <div className="h-48 bg-agenko-gray/20"></div>
                      <div className="p-6">
                        <div className="h-6 bg-agenko-gray/20 rounded mb-4"></div>
                        <div className="h-20 bg-agenko-gray/20 rounded mb-4"></div>
                        <div className="flex gap-2">
                          <div className="h-8 bg-agenko-gray/20 rounded w-20"></div>
                          <div className="h-8 bg-agenko-gray/20 rounded w-20"></div>
                        </div>
                      </div>
                    </div>
                  ...
                  {projects.map((project, index) => (
                    ...
                    >
                      {project.hero_image ? (
                        ...
                        <div className="aspect-video bg-gradient-to-br from-agenko-green/20 to-agenko-dark/20 flex items-center justify-center">
                          <Beaker className="h-16 w-16 text-agenko-green/40" />
                        </div>
                      )}
                      ...
                      <div className="p-6">
                        ...
                        <div className="flex flex-wrap gap-2 mb-3">
                          {project.tags.slice(0, 3).map((tag) => (
                            <Badge key={tag} variant="secondary" className="text-xs bg-agenko-green/10 text-agenko-green">
                              {tag}
                            </Badge>
                          ))}
                        ...
                        <div className="flex gap-2">
                          {project.demo_url && (
                            <Button size="sm" variant="outline" asChild className="border-agenko-gray/20 text-agenko-gray-light hover:border-agenko-green hover:text-agenko-green">
                              <a 
                ...
                <div className="text-center py-12">
                  <Beaker className="h-16 w-16 text-agenko-gray/40 mx-auto mb-4" />
                  <p className="text-agenko-gray-light text-lg">No experiments available yet.</p>
                  <p className="text-agenko-gray-light mt-2">Check back soon for innovative projects and demos.</p>
                </div>
              )}
            </div>
          </section>
